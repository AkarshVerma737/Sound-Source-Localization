...
load(sprintf('/media/adityar/FFDOA-DANN/data/recording_train_phi_rand_%d_%d.mat',smir_instance,run_instance))
...
if(shmmagphaseshres == 1)
    ...
    saveshmmagphaseshres = '/media/adityar/FFDOA-DANN/data/shmmagphaseshres_train_phi_rand_%d_%d.mat';
end
