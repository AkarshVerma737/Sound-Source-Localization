...
load('/media/adityar/FFDOA-DANN/data/recording_validate_theta_rand.mat')
...
if(shmmagphaseshres == 1)
    ...
    saveshmmagphaseshres = '/media/adityar/FFDOA-DANN/data/shmmagphaseshres_validate_theta_rand.mat';
end
