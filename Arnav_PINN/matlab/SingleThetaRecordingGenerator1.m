...
load(sprintf('/media/adityar/FFDOA-DANN/data/SMIR_train_theta_rand_%d.mat',smir_instance))
...
save(sprintf('/media/adityar/FFDOA-DANN/data/recording_train_theta_rand_%d_%d.mat',smir_instance,run_instance),'features','-v7.3');
end
end
