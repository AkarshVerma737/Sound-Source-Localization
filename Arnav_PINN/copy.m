...
for loop = 1:100
    ...
    %theta_iter = theta_src * pi/180;
        ...
        for phi_src = 0:2:90
            ...
            save(sprintf('D:/Projects/Learning based Beamforging/SH/Generated Audio/Cat90/azimuth_feats_azi%dele%d_%d.mat', phi_src, theta_src, loop), 'inputfeats_combined'); 
        end
    end
end