...
% figure(1); print -dpng ../../../figures/chapter1/fig_sh_balloon_angle.png % angular view
% figure(2); print -dpng ../../../figures/chapter1/fig_sh_balloon_z.png     % +z axis view
% figure(3); print -dpng ../../../figures/chapter1/fig_sh_balloon_x.png     % +x axis view
% figure(4); print -dpng ../../../figures/chapter1/fig_sh_balloon_y.png     % +y axis view

% Print figures in eps
% figure(1); print -depsc -loose -r300 ../../../figures/chapter1/fig_sh_balloon_angle.eps % angular view
% figure(2); print -depsc -loose -r300 ../../../figures/chapter1/fig_sh_balloon_z.eps     % +z axis view
% figure(3); print -depsc -loose -r300 ../../../figures/chapter1/fig_sh_balloon_x.eps     % +x axis view
% figure(4); print -depsc -loose -r300 ../../../figures/chapter1/fig_sh_balloon_y.eps     % +y axis view
