...
% Rotations
fnm1=wignerD(N,0,45*pi/180,0)*fnm;
fnm2=wignerD(N,180*pi/180,45*pi/180,0)*fnm;
fnm3=wignerD(N,0,180*pi/180,0)*fnm;
...
axis tight;
camzoom(0.85);
title('$\Lambda(180^\circ,45^\circ,0)$','Interp','Latex','FontSize',AxisFontSize);

subplot(224);
plot_balloon(fnm3,[180,0],0.05);
camzoom(0.9);
axis tight;
title('$\Lambda(0,180^\circ,0)$','Interp','Latex','FontSize',AxisFontSize);

% Print figure in png
% print -dpng ../../../figures/chapter1/fig_rotation.png

% Print figure in eps
% print -depsc -loose -r300 ../../../figures/chapter1/fig_rotation.eps
