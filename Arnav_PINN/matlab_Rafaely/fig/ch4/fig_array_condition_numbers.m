...
legend('equal-angle','Gaussian','nearly-uniform');
xlabel('$kr$','Interp','Latex');
ylabel('Condition number','Interp','Latex');
...
hold off;
axis([kr(1) kr(end) 1 10000]);
legend('rigid','shell - uniform','shell - optimal','Location','NorthEast');
xlabel('$kr$','Interp','Latex');
ylabel('Condition number','Interp','Latex');
set(gca,'FontSize',AxisFontSize);
...
% figure(1); print -dpng ../../../figures/chapter4/fig_k_rigid.png;
% figure(2); print -dpng ../../../figures/chapter4/fig_k_open.png;
% figure(3); print -dpng ../../../figures/chapter4/fig_k_card_dual.png;
% figure(4); print -dpng ../../../figures/chapter4/fig_k_shell.png;
% figure(5); print -dpng ../../../figures/chapter4/fig_k_rGA_th.png;
% figure(6); print -dpng ../../../figures/chapter4/fig_k_rGA_ph.png;

% Print figures in eps
% figure(1); print -depsc -loose ../../../figures/chapter4/fig_k_rigid.eps;
% figure(2); print -depsc -loose ../../../figures/chapter4/fig_k_open.eps;
% figure(3); print -depsc -loose ../../../figures/chapter4/fig_k_card_dual.eps;
% figure(4); print -depsc -loose ../../../figures/chapter4/fig_k_shell.eps;
% figure(5); print -depsc -loose ../../../figures/chapter4/fig_k_rGA_th.eps;
% figure(6); print -depsc -loose ../../../figures/chapter4/fig_k_rGA_ph.eps;
