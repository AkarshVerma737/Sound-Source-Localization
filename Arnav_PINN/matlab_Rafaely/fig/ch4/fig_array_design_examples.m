...
N0=5;
r=0.08;
kr=linspace(0.01,7,400);
kr=sort([kr,[3.1415 4.493 5.764 6.283 6.988]]); % add zeros for resolution
c=343;
kr2f=c/(2*pi*r);
f=kr*kr2f;

[tmp f1000]=min(abs(f-1000)); %find 1000Hz
...
xlabel('Frequency (Hz)','Interp','Latex');
...
hold on; 
g=plot(f(f1000),20*log10(abs(bn0(6,f1000))),'kx');
set(g,'LineWidth',2,'MarkerSize',AxisFontSize);
...
text(1.03*N0*kr2f,20,'$kr=5$','FontSize',AxisFontSize,'Color','k','Interp','Latex');
hold on; 
g=plot(f(f1000),20*log10(abs(bn1(6,f1000))),'kx');
set(g,'LineWidth',2,'MarkerSize',AxisFontSize);

% Print figures in png
% figure(1); print -dpng ../../../figures/chapter4/fig_design_examples_open.png
% figure(2); print -dpng ../../../figures/chapter4/fig_design_examples_rigid.png

% Print figures in eps
% figure(1); print -depsc -loose ../../../figures/chapter4/fig_design_examples_open.eps
% figure(2); print -depsc -loose ../../../figures/chapter4/fig_design_examples_rigid.eps
