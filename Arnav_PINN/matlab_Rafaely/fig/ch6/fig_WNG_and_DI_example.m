...
axis([0,max(kr),-30,30]);
xlabel('$kr$','Interp','Latex');
ylabel('$WNG\,\,$ (dB)','Interp','Latex');
set(gca,'FontSize',AxisFontSize);

% Print figures in png
% figure(1); print -dpng ../../../figures/chapter6/fig_design_example1.png
% figure(2); print -dpng ../../../figures/chapter6/fig_design_example2.png

% Print figure in eps
% figure(1); print -depsc -loose ../../../figures/chapter6/fig_design_example1.eps
% figure(2); print -depsc -loose ../../../figures/chapter6/fig_design_example2.eps
