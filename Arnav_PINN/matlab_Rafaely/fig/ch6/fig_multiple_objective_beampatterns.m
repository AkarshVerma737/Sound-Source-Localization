...
xlabel('$\Theta$ (degrees)','interp','Latex');
...
% figure(1); print -dpng ../../../figures/chapter6/fig_multiple1.png
% figure(2); print -dpng ../../../figures/chapter6/fig_multiple2.png

% Print figures in eps
% figure(1); print -depsc -loose ../../../figures/chapter6/fig_multiple1.eps
% figure(2); print -depsc -loose ../../../figures/chapter6/fig_multiple2.eps
