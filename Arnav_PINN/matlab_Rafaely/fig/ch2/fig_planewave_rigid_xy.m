...
title(strcat('$r_a=\,\,$',num2str(ra1)),'Interp','Latex');
hold on;
...
xlabel('$x$ (m)','Interp','Latex');
ylabel('$y$ (m)','Interp','Latex');
title(strcat('$r_a=\,\,$',num2str(ra2)),'Interp','Latex');
hold on;
...
xlabel('$x$ (m)','Interp','Latex');
ylabel('$y$ (m)','Interp','Latex');
title(strcat('$r_a=\,\,$',num2str(ra3)),'Interp','Latex');
hold on;
fill(ra3*cos(z),ra3*sin(z),'w');

% Print figures in png
% figure(1); print -dpng ../../../figures/chapter2/fig_pressureNxy_rigid1.png
% figure(2); print -dpng ../../../figures/chapter2/fig_pressureNxy_rigid2.png
% figure(3); print -dpng ../../../figures/chapter2/fig_pressureNxy_rigid3.png

% Print figures in eps
% figure(1); print -depsc -loose ../../../figures/chapter2/fig_pressureNxy_rigid1.eps
% figure(2); print -depsc -loose ../../../figures/chapter2/fig_pressureNxy_rigid2.eps
% figure(3); print -depsc -loose ../../../figures/chapter2/fig_pressureNxy_rigid3.eps
